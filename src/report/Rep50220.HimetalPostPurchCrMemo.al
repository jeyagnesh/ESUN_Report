report 50220 "HiMetal-Post Purch CR. Memo"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    DefaultRenderingLayout = "Post Purch Cr Memo";
        ...
        dataitem("Purch. Cr. Memo Hdr."; "Purch. Cr. Memo Hdr.")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(DocumentDate; Format("Purch. Cr. Memo Hdr."."Document Date", 0, '<Day,2>/<Month,2>/<Year>'))
                    {
                    ...
                    column(VendorOrder_No; "Purch. Cr. Memo Hdr."."Vendor Order No.")
                    {

                    }
                    column(PONo; "Purch. Cr. Memo Hdr."."Purchase Order No.") { }
                    column(PurchaseInvoiceNo; "Purch. Cr. Memo Hdr."."Vendor Invoice No.") { }
                    column(PaymentTermsText; PaymentTermsText)
                    {

                    }
                    column(Purchase; "Purch. Cr. Memo Hdr."."Purchaser Code")
                    {
                    ...
                    column(Work_Description; "Purch. Cr. Memo Hdr.".GetWorkDescription())
                    {
    ...
    rendering
    {
        layout("Post Purch Cr Memo")
        {
            Type = RDLC;
            LayoutFile = './Himetal-ReportLayout/50220.ReportLayout.PostPurchCrMemo.rdl';
        }
    }
    ...
    var
        ...
        ReqPDocTittleOpt: Option "Purchase Credit Note";
        VarDocTittle: Text;
        ...
        NoOfLoops: Integer;
        NoOfCopies: Integer;
        PurchaseOrderLbl: Label 'Purchase Credit Note';
        NoLbl: Label 'No.';
        DateLbl: Label 'Date';
        ...
        SeqNo: Integer;
        RecPurcLine: Record "Purch. Cr. Memo Line";
        SubTotal: Decimal;
        SubTotalSGD: Decimal;
        Gst: Decimal;
        GstSGD: Decimal;
        ...
        FirstLine: Record "Purch. Cr. Memo Line";
        GSTRate: Decimal;
