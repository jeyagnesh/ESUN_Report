report 50169 "Receipt Voucher2"
{


    DefaultLayout = RDLC;
    RDLCLayout = './ReportLayout/50169.ReportLayout.Receipt Voucher2.rdl';
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem("Integer"; "Integer")
        {
            ...
            dataitem("Gen. Journal Line"; "Gen. Journal Line")
            {
                ...
                column(BankAmtinWords; BankAmtinWords[1] + ' ' + BankAmtinWords[2])
                {
                ...
                */
                ...
                begin
                    ...
                    GenJnlLn.SetFilter("Account Type", '<>%1', GenJnlLn."Account Type"::"Bank Account");
                    if GenJnlLn.FindSet() then
                        repeat
                            TotalLineAmount1 += GenJnlLn."VAT Base Amount";
                        until GenJnlLn.next() = 0;

                    InitTextVariable;
                    FormatNoText(BankAmtinWords, Abs(TotalLineAmount1), CurrCode);
                    ...
                    lrec_GenJnlLine.SetRange("Journal Batch Name", "Journal Batch Name");
                    lrec_GenJnlLine.SetRange("Document No.", "Document No.");
                    lrec_GenJnlLine.SetRange("Bal. Account Type", "Bal. Account Type"::"G/L Account");
                    lrec_GenJnlLine.SetFilter("Bal. Account No.", '<>%1', '');
                    if lrec_GenJnlLine.FindFirst then begin
                        GLAccount.reset();
                        if GLAccount.get("Gen. Journal Line"."Bal. Account No.") then
                            Name := GLAccount.Name;
                    end;
                end;
                ...
                begin
                    ...
                    "Gen. Journal Line".SetRange("Gen. Journal Line"."Journal Template Name", JournalTemplateName);
                    "Gen. Journal Line".SetRange("Gen. Journal Line"."Journal Batch Name", JournalBatchName);
                    "Gen. Journal Line".SetFilter("Gen. Journal Line"."Document No.", '%1..%2', DocNo, DocNoLast);
                    Sequence := 0;
    ...
    var
        ...
        BankAmtinWords: array[2] of Text;
