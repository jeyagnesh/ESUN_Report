report 50155 "Payment Voucher"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ReportLayout/50155.ReportLayout.Payment Voucher.rdl';
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem("Gen. Journal Line"; "Gen. Journal Line")
        {
            ...
            column(RecCompInfo_Picture1; CompanyInfo.Picture1) { }
            ...
            dataitem("Vendor Ledger Entry"; "Vendor Ledger Entry")
            {
                ...
                column(DocNo1; "Vendor Ledger Entry"."External Document No.")// "Document No.")
                {
                }
            ...
            begin
                ...
                Clear(AmtInWords);//110424
                InitTextVariable;
                FormatNoText(AmtInWords, Abs(Amount + GenJnlLn.Amount), CurrCode);
