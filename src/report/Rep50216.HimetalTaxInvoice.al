report 50216 "Himetal-Tax Invoice"
{
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(Posted_SalesInvoice_No; "Sales Invoice Header"."No.")
                    {
                    ...
                    column(DocumentDate; Format("Sales Invoice Header"."Document Date", 0, '<Day,2>/<Month,2>/<Year>'))
                    {
                    ...
                    column(Shipment_Date; Format("Sales Invoice Header"."Shipment Date", 0, '<Day,2>/<Month,2>/<Year>'))
                    {

                    }
                    column(Invoice_No; "Sales Invoice Header"."Applies-to Doc. No.")
                    {
            ...
            trigger OnAfterGetRecord()
            begin
                workDescription := "Sales Invoice Header".GetWorkDescription();
                Clear(VarShipTo);
                Clear(VarSellTo);
                Clear(VarCompInfo);
                Clear(SubTotal);
    ...
    rendering
    {
        ...
        {
            Type = RDLC;
            LayoutFile = './Himetal-ReportLayout/50216.ReportLayout.TaxInvoice.rdl';
        }
    }
