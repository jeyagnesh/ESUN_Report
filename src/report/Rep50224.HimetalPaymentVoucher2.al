report 50224 "Himetal Payment Voucher2"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Himetal-ReportLayout/50224.ReportLayout.PaymentVoucher2.rdl';
    ApplicationArea = All;
    Caption = 'Payment Voucher2';
