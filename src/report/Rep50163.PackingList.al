report 50163 PackingList
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    DefaultRenderingLayout = PackingList;
        ...
        dataitem(Header; "Sales Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(Contract_No; Header."Sales Contract No.")
                    {
            ...
            begin
                ...
                case ReqPDocTittleOpt of
                    ReqPDocTittleOpt::"PACKING LIST":
                        VarDocTittle := 'PACKING LIST';
                end;
                Clear(varBillTo);
                Clear(varShipTo);
                Clear(VarCompInfo);
    ...
    rendering
    {
        ...
        {
            Type = RDLC;
            LayoutFile = './ReportLayout/50163.ReportLayout.PackingList.rdl';
        }
    }
    ...
    var
        ...
        ReqPDocTittleOpt: Option "PACKING LIST";
        VarDocTittle: Text;
