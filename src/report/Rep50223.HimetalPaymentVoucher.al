report 50223 "Himetal Payment Voucher"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Himetal-ReportLayout/50223.ReportLayout.PaymentVoucher.rdl';
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem("Gen. Journal Line"; "Gen. Journal Line")
        {
            ...
            column(Company_website; CompanyInfo."Home Page") { }
            ...
            dataitem("Vendor Ledger Entry"; "Vendor Ledger Entry")
            {
                ...
                column(DocNo1; "External Document No.")//"Document No.")
                {
                }
            ...
            begin
                ...
                if "Account Type" = "Account Type"::Vendor then begin
                    if Vendor.Get("Account No.") then begin
                        Clear(PayToAddr);
                        PayToAddr[1] := Vendor.Name;
                        PayToAddr[2] := Vendor."Name 2";
                        PayToAddr[5] := Vendor."Address 2";
                        PayToAddr[3] := Vendor.Address;
