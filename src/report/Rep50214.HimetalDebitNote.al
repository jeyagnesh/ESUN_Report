report 50214 "Himetal-Debit Note"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    DefaultRenderingLayout = "Debit Note";
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(DocumentNo; "Sales Invoice Header"."Document No.") { }
    ...
    rendering
    {
        ...
        {
            Type = RDLC;
            LayoutFile = './Himetal-ReportLayout/50214.ReportLayout.DebitNote.rdl';
        }
    }
