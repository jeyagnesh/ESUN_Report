report 50165 "Performa Invoice2"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    DefaultRenderingLayout = "Proforma Invoice2";
    Caption = 'Proforma Invoice 2';
    dataset
    {
        dataitem("Header"; "Sales Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(OrderNo; Header."Sales Contract No.")
                    {
                    ...
                    column(ShipToNo; Header."Bill-to Customer No.")
                    {
            ...
            begin
                ...
                if Customer.get("Bill-to Customer No.") then
                    BillTo[8] := 'IEC Code: ' + Customer."IEC Code";
                ...
                Customer.Reset();
                if Customer.get("Bill-to Customer No.") then
                    ShipTo[8] := 'IEC Code: ' + Customer."IEC Code";
    ...
    rendering
    {
        layout("Proforma Invoice2")
        {
            Type = RDLC;
            LayoutFile = './ReportLayout/50165.ReportLayout.PerformaInvoice2.rdl';
        }
    }
    ...
    var
        ...
        Text004: Label 'Proforma Invoice %1', Comment = '%1 = Document No.';
