report 50162 EsunDeliveryOrder
{
    ...
    rendering
    {
        ...
        {
            Type = RDLC;
            LayoutFile = './ReportLayout/50162.ReportLayout.EsunDeliveryorder.rdl';
        }
    }
