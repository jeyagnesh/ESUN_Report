report 50221 "Himetal-Proforma Invoice SlsQt"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    DefaultRenderingLayout = "Sales Quote";
    PreviewMode = PrintLayout;
    Caption = 'Himetal-Proforma Invoice SlsQt';
    dataset
    {
    ...
    rendering
    {
        ...
        {
            Type = RDLC;
            LayoutFile = './Himetal-ReportLayout/50221.ReportLayout.ProformaInvoiceSalesQuote.rdl';
        }
    }
    var
