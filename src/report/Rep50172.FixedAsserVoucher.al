report 50172 "Fixed Asset Voucher"
{
    ApplicationArea = All;
    Caption = 'Fixed Asset Journal';
    UsageCategory = ReportsAndAnalysis;
    RDLCLayout = './ReportLayout/50172.ReportLayout.FixedAssetVoucher.rdl';
    ...
    dataset
    {
        dataitem("Gen. Journal Line"; "Gen. Journal Line")
        {
            ...
            column(PayToAddr6; Vendor1."No.")//PayToAddr1[6])
            {
            }
            column(PayToAddr7; PayToAddr1[7])
            {
            }
            column(PayToAddr8; PayToAddr1[8])
            {
            }
