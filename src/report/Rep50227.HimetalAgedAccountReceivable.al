report 50227 HimetalAgedAccountReceivable
{
    DefaultLayout = RDLC;
    RDLCLayout = './Himetal-ReportLayout/50227.ReportLayout.AgedAccountReceivable.rdl';
    ApplicationArea = all;
    Caption = 'Himetal Aged Accounts Receivable';
    ...
    dataset
    {
        dataitem(Header; "Integer")
        {
            ...
            column(AgingByDueDate; AgingBy = AgingBy::"Posting Date")//::"Due Date")
            {
            }
            ...
            dataitem(Customer; Customer)
            {
                ...
                dataitem(CurrencyLoop; "Integer")
                {
                    ...
                    begin
                        ...
                        if Number = 1 then begin
                            if not TempCurrency.FindSet() then begin
                                CurrReport.Break();
                                NumberOfLines -= 1;
                            end;
                        end else
            ...
            area(content)
            {
                group(Options)
                {
                    ...
                    field(Agingby; AgingBy)
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Aging by';
                        OptionCaption = 'Posting Date,Due Date,Document Date';
    ...
    var
        ...
        EndingDate: Date;
        AgingBy: Option "Posting Date","Due Date","Document Date";
        ...
        Text009: Label 'Posting Date,Due Date,Document Date';
