report 50222 "HiMetal-PostPurchaseInvoice"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    DefaultRenderingLayout = "PostPurchase Invoice";
        ...
        dataitem("Purch. Inv. Header"; "Purch. Inv. Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(DocumentDate; Format("Purch. Inv. Header"."Document Date", 0, '<Day,2>/<Month,2>/<Year>'))
                    {
                    ...
                    column(VendorOrder_No; "Purch. Inv. Header"."Vendor Order No.")
                    {
                    ...
                    column(ShippingTerms; "Purch. Inv. Header"."Shipment Effected")
                    {

                    }
                    column(Purchase; "Purch. Inv. Header"."Purchaser Code")
                    {
                    ...
                    // column(Work_Description; "Purch. Inv. Header".GetWorkDescription())
                    // {
    ...
    rendering
    {
        layout("PostPurchase Invoice")
        {
            Type = RDLC;
            LayoutFile = './Himetal-ReportLayout/50222.ReportLayout.PostPurchaseInvoice.rdl';
        }
    }
    ...
    var
        ...
        NoOfLoops: Integer;
        NoOfCopies: Integer;
        PurchaseOrderLbl: Label 'Purchase Invoice';
        NoLbl: Label 'No.';
        DateLbl: Label 'Date';
        ...
        SeqNo: Integer;
        RecPurcLine: Record "Purch. Inv. Line";
        SubTotal: Decimal;
        SubTotalSGD: Decimal;
        Gst: Decimal;
        GstSGD: Decimal;
        ...
        FirstLine: Record "Purch. Inv. Line";
        GSTRate: Decimal;
